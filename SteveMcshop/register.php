...
<html>
  ...
  <div class="container">
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href=""><font size="4"><i class="fa fa-user-plus" aria-hidden="true"></i> สมัครสมาชิก</font></a></li>
            <li><a href=""></a></li>
          </ul>
        </div>
      </div>
    ...
    <br>
    <div class="row">
    <form action="_action/_register.php" method="post">

    <div class="col-sm-6">
    <div class="panel panel-warning">
      <div class="panel panel-heading"><font size="4">Register : สมัครสมาชิก</font></div>
      <div class="panel panel-body">
          <input class="form-control" type="text" name="username" id="username" placeholder="USERNAME">
          <br>
          <input class="form-control" type="text" name="password" id="password" placeholder="PASSWORD">
          <br>
          <input class="form-control" type="text" name="con_password" id="con_password" placeholder="CONFIRM PASSWORD">
          <br>
